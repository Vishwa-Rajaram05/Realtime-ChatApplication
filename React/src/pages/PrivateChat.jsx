...
const PrivateChat = ({
    ...
    const messageIdsRef = userRef(new Set());
    ...
    useEffect( () => {
        ...
        loadMessageHistory()
        registerPrivateMessageHandler(recipientUser, handleIncomimgPrivateMessage);
    ...
    const handleIncomimgPrivateMessage = (privateMessage) => {
        ...
        <div className="private-chat-window">
            ...
            <div className="private-message-container">
                {message.length ===0 ? (
                    ...
                    messages.map((msg) => (
                        <div key={msg.id} className={`private-message ${msg.sender === currentUser ? 'own-message' : 'received'}`}>
            ...
            <div className="private-message-input-container">
                <form onSubmit={sendPrivateMessage} className="private-messages-form">
                    <input 
                        type="text"
